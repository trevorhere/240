...
public class MainServer {
    ...
    private void run(String portNumber) {
      ...
      //  server.createContext("/games/list", new ListGamesHandler());
        ...
        server.createContext("/person", new PersonHandle());
        server.createContext("/event", new EventHandle());
...
/**
 *
 * Note from help session
 * fill funct tips:
 * random events, like completed this lab
 *
 *
 * still working on login route, once you get this, port it over to other routes,
 * just need to get request service response sorted also database
 * **/